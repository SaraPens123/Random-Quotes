			...
			<div id="wrapper" className="quotes-wrapper" onLoad={this.newQuote}>
          		<div id="quote-box" className="box">
            		...
            		<div id="buttons" className="quote-buttons">
            			<a id="tweet-quote" className="twitter" title="Tweet this quote!" href="twitter.com/intent/tweet" href="https://www.twitter.com/intent/tweet" target="_blank"><img id="twitter-logo" className="twitter-img" src={logo} /></a>
